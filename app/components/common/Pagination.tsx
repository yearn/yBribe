...
import {IconPaginationArrow} from '@yearn-finance/web-lib/icons/IconPaginationArrow.js';
		...
		<>
			<div className={'flex flex-1 justify-between md:hidden'}>
				<a
					...
					href={'#'}
					className={
						'relative inline-flex items-center rounded-md border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50'
					}>
					{'Previous'}
				</a>
				<a
					...
					href={'#'}
					className={
						'relative ml-3 inline-flex items-center rounded-md border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50'
					}>
					{'Next'}
				</a>
			</div>
