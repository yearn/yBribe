...
function	NewVault(): ReactElement {
	...
	const	rewardsForCurrentGauge = useMemo((): TKeyStringBN => {
		...
		return rewards[toAddress(selectedOption.value.gauge)];
	}, [selectedOption.value, rewards]);
	...
	**************************************************************************/
	...
	return (
		<div className={'mx-auto block w-full max-w-[800px] bg-neutral-100 p-4 md:p-10'}>
